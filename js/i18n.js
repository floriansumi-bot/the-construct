...
window.I18N = {
  ...
  dict: {
    en: {
      ...
      adfree_code_ph: "paste your unlock code…",
      adfree_unlock: "UNLOCK",
      adfree_ok: "Ads removed — thank you! ✓",
      adfree_bad: "That code isn't valid.",
      adfree_active: "Ad-free is active on this profile.",
      adfree_manage: "MANAGE",
      adfree_note: "One-time unlock, tied to your profile code and synced across devices. Secure checkout handled by the store.",
    ...
    fr: {
      ...
      adfree_code_ph: "collez votre code de déblocage…",
      adfree_unlock: "DÉBLOQUER",
      adfree_ok: "Pubs retirées — merci ! ✓",
      adfree_bad: "Ce code n'est pas valide.",
      adfree_active: "Le mode sans pub est actif sur ce profil.",
      adfree_manage: "GÉRER",
      adfree_note: "Déblocage unique, lié à votre code de profil et synchronisé entre appareils. Paiement sécurisé géré par la boutique.",
